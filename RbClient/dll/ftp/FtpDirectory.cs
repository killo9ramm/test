...
namespace Ftp
{
	...
	public class FtpDirectory : IFtpDirectory
	{
		...
		public FtpDirectory FindSubdirectory(string dirName)
		{
           ...
           // return FindSubdirectory(dirName, true);
		}
        ...
        {
            PutFile(localFile, remoteFile, 0);
        }
		public void PutFile(string localFile, string remoteFile, long offset)
		{
			CheckSessionCurrentDirectory();
        ...
        {
            GetFile(localFile, remoteFile, 0);
        }
        public void GetFile(string localFile, string remoteFile, long offset)
		{
			InitHashtable();
		...
		public FtpOutputDataStream CreateFileStream(string newFileName)
		{
			...
			try {
				m_session.ControlChannel.STOR(newFileName, 0);
