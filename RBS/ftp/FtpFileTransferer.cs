...
namespace Ftp
{
	...
	internal class FtpFileTransferer : IFtpFileTransferArgs
	{
		...
		private delegate void FtpDelegate(string remoteFileName, long offset);
		...
		internal FtpFileTransferer(FtpDirectory transferStarter, string localFile, string remoteFile, long totalBytes, TransferDirection dir)
		{
			...
			if(dir == TransferDirection.Upload) {
                ...
                m_localFileOpenMode = FileMode.OpenOrCreate;
			}
		}
        ...
        //{
            //StartTransfer(0);
        //}
		internal void StartTransfer(long offset)
		{
			...
			try {
                ...
                m_ftpFileCommandRoutine(m_remoteFile, offset);
